...
//		System.out.println((today.get(Calendar.AM_PM)));
	...
	public static void printDate(String contents, Calendar date) {
		...
		System.out.println(contents+"은"+ year + "/" +month+"/"+day+"/"+dayWeek+ "("+hour+"시)"+minute+"분"+second+"초"+millisecond+"밀리초입니다");
