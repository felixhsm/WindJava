package com.wind.day16.stream.io;
...
public class Exam_Read {
	public static void main(String[] args) { // 메인을 기준으로 입출력 판단필요
		// 파일을 읽어라~
		try {
			InputStream is = new FileInputStream("C:\\Windows\\system.ini"); // InputStream은 최상위 클래스, 업캐스팅 적용 가능
			Reader fr = new FileReader("src/com/wind/day16/stream/exercise/Exercise_MemoPad.java");
			int readCount;
